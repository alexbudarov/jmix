...
@Scope("prototype")
public class LegacyExcludeAction extends LegacyRemoveAction
     ...
     */
    public static LegacyExcludeAction create(LegacyListComponent target) {
     ...
     */
    public static LegacyExcludeAction create(LegacyListComponent target, boolean autocommit, boolean confirm) {
     ...
     */
    public static LegacyExcludeAction create(LegacyListComponent target, boolean autocommit, boolean confirm, String id) {
     ...
     * @param target     component containing this action
     */
    public LegacyExcludeAction(LegacyListComponent target) {
     ...
     * @param confirm       whether to show the confirmation dialog to user
     */
    public LegacyExcludeAction(LegacyListComponent target, boolean autocommit, boolean confirm) {
     ...
     * @param id            action's name
     */
    public LegacyExcludeAction(LegacyListComponent target, boolean autocommit, boolean confirm, String id) {
