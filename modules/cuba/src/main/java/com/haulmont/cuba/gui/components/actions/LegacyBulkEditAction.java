...
@Scope("prototype")
public class LegacyBulkEditAction extends LegacyItemTrackingAction
     ...
     */
    public static LegacyBulkEditAction create(LegacyListComponent target) {
        return AppBeans.getPrototype("cuba_BulkEditAction", target);
    }

    public LegacyBulkEditAction(LegacyListComponent target) {
