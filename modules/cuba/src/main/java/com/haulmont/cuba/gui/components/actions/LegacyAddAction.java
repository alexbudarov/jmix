...
@Scope("prototype")
public class LegacyAddAction extends LegacyListAction
     ...
     * @param target    component containing this action
     */
    public LegacyAddAction(LegacyListComponent target) {
     ...
     * @param handler   lookup handler. If null, an instance of {@link DefaultHandler} will be used.
     */
    public LegacyAddAction(LegacyListComponent target, @Nullable Window.Lookup.Handler handler) {
     ...
     * @param openType  how to open the editor screen
     */
    public LegacyAddAction(LegacyListComponent target, @Nullable Window.Lookup.Handler handler, OpenType openType) {
