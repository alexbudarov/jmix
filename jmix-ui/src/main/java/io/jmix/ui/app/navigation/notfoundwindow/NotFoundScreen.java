...
public class NotFoundScreen extends Screen {
    ...
    protected void onInit(InitEvent event) {
        ...
        msgLabel.setValue(messages.formatMessage(getClass(), "notAssociatedRoute", requestedRoute));

        window.add(msgLabel);

        window.setCaption(messages.formatMessage(getClass(), "tabCaption", requestedRoute));
    }
}
