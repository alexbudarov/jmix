    ...
    public void accept(T value) throws ValidationException {
        ...
        if (Collection.class.isAssignableFrom(clazz)) {
            ...
            if (min > size || size > max) {
                this.defaultMessage = messages.getMessage(getClass(), "validation.constraints.collectionSizeRange");
            ...
            if (min > length || length > max) {
                this.defaultMessage = messages.getMessage(getClass(), "validation.constraints.sizeRange");
